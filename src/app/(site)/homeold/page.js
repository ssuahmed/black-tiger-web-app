...
export async function generateMetadata() {
  ...
  return {
    title:
      title === "Homepage"
        ? "Black Tiger Lubricants (legacy home)"
        : `${title} | Black Tiger (legacy home)`,
    description: "Legacy homepage layout retained for comparison.",
    robots: { index: false, follow: false },
  };
}

/** Legacy homepage (pre–1440 mock layout). */
